      ...
      >
        ...
        <div className="p-3 flex-shrink-0 space-y-1.5">
          <Button
            ...
            className="w-full justify-start gap-2 h-10 rounded-xl bg-primary text-primary-foreground shadow-lg shadow-primary/10 hover:bg-primary/90 transition-colors"
          >
