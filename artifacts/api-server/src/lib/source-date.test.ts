...
describe("extractPublishedAtFromHtml", () => {
  it("reads publication metadata regardless of attribute order", () => {
    expect(extractPublishedAtFromHtml(
  ...
  it("rejects invalid, implausibly old, and future dates", () => {
    expect(extractPublishedAtFromHtml('<meta property="article:published_time" content="not-a-date">')).toBeNull();
    expect(extractPublishedAtFromHtml('<meta property="article:published_time" content="1800-01-01">')).toBeNull();
    expect(extractPublishedAtFromHtml('<meta property="article:published_time" content="2999-01-01">')).toBeNull();
  });
});
